            ...
            <div className="bg-white w-full max-w-sm mx-auto rounded-lg shadow-lg p-6">
                ...
                <div className="mt-6 flex justify-end gap-3">
                    {onCancel && (
                        <button
                            onClick={onCancel}
                            className="px-4 py-2 hover:cursor-pointer rounded-md border text-gray-600 hover:bg-gray-100"
                        >
                            Cancel
                        </button>
                    )}
                    <button
                        onClick={onOk || (() => { })}
                        className="px-4 py-2 rounded-md hover:cursor-pointer bg-indigo-600 text-white hover:bg-indigo-700"
                    >
                        OK
                    </button>
